...
namespace DragonCurve
{
    ...
    {
        public DragonCurveComponent() : base("DragonCurve", "DC", "Description","User", "Test")
        {
        }
        ...
        {
            pManager.AddCurveParameter("Dragon curves", "DragonCrv", "Create dragon curves", GH_ParamAccess.item);
            pManager.AddPointParameter("Point", "pts", "DragonCrvPts", GH_ParamAccess.list);
        }
        #endregion
